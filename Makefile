...
cover:
	go test -cover -coverpkg github.com/baldurstod/manta,github.com/baldurstod/manta/vbkv -coverprofile /tmp/manta.cov -v
...
update-protobufs:
	...
	$(SED) -i '1isyntax = "proto2";\n\npackage dota;\noption go_package = "github.com/baldurstod/manta/dota;dota";\n' dota/*.proto
